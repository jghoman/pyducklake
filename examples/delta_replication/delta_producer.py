"""Delta Producer: generates analytics events and writes them to a Delta table.
...
def log(msg: str) -> None:
    ...
    print(f"[delta-producer {ts}] {msg}", flush=True)
...
def main() -> None:
    ...
    log(f"writing to Delta table at {DELTA_TABLE_PATH}")
